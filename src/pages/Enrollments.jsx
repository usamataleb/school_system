  ...
  return (
    <div>
      ...
      <div className="table-card">
        <div className="table-card-header"><h3>All Enrollments</h3>           <p>{enrollments.length} total enrollment{enrollments.length !== 1 ? 's' : ''}</p>
 </div>
        {loading ? (
            ...
            <tbody>
              {enrollments.length === 0 ? (
                ...
                <tr key={e.id}>
                  ...
                  <td><span className="badge badge-a">{e.course_title}</span></td>
